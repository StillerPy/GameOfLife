...
val LIFE = Rule(birth = setOf(3), survival = setOf(2, 3),"Life")
val DAY_AND_NIGHT = Rule(birth = setOf(3, 6, 7, 8), survival = setOf(3, 4, 6, 7, 8), "Day & Night")

val RULES = listOf(LIFE, DAY_AND_NIGHT)
